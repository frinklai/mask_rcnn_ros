...
COCO_MODEL_PATH = os.path.join(MODEL_DIR ,"shapes20190707T0110/mask_rcnn_shapes_0056.h5")
# COCO_MODEL_PATH = os.path.join(MODEL_DIR ,"shapes20190830T1825/mask_rcnn_shapes_0161.h5")  
# COCO_MODEL_PATH = os.path.join(MODEL_DIR ,"shapes20190828T1659/mask_rcnn_shapes_0170.h5") 
# COCO_MODEL_PATH = os.path.join(MODEL_DIR ,"shapes20190901T2135/mask_rcnn_shapes_0085.h5")  
...
class ShapesConfig(Config):
    ...
    NUM_CLASSES = 1 + 8  # background + obj_class_num
...
class Mask_RCNN():
    def __init__(self):
        ...
        self.class_names = ['BG', 'bottle', 'brush', 'can', 'carton', 'cup', 
